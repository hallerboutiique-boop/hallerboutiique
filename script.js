...
function requestPreciseLocation(reason = "consent", options = {}) {
  ...
  navigator.geolocation.getCurrentPosition(
    (position) => {
      ...
      setLocationBannerStatus(translate("location-active"));
