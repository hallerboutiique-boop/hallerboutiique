...
const bundleTryOnTranslations = {
  it: {
    "bundle-tryon-kicker": "Try-on abiti AI", "bundle-tryon-title": "Prova fino a 2 capi", "bundle-tryon-description": "Il try-on del checkout cambia solo gli abiti. Scarpe, borse e accessori restano invariati.", "bundle-tryon-limit": "Solo abiti · massimo 2 prodotti", "bundle-tryon-upload": "Carica la tua foto", "bundle-tryon-result-empty": "Il try-on dei tuoi abiti comparira qui.", "bundle-tryon-generate": "Genera try-on abiti", "bundle-tryon-progress": "Avanzamento try-on abiti AI", "bundle-tryon-empty": "Aggiungi almeno un capo d'abbigliamento al carrello. Il try-on accetta massimo 2 capi.", "bundle-tryon-loaded": "Foto caricata. I capi sono pronti.", "bundle-tryon-preparing": "Preparazione dei capi selezionati", "bundle-tryon-inputs-ready": "Foto cliente e capi selezionati pronti", "bundle-tryon-ready": "Try-on abiti pronto"
  },
  en: {
    "bundle-tryon-kicker": "AI clothing try-on", "bundle-tryon-title": "Try on up to 2 garments", "bundle-tryon-description": "Checkout try-on changes clothing only. Shoes, bags and accessories stay unchanged.", "bundle-tryon-limit": "Clothing only · maximum 2 products", "bundle-tryon-upload": "Upload your photo", "bundle-tryon-result-empty": "Your clothing try-on will appear here.", "bundle-tryon-generate": "Generate clothing try-on", "bundle-tryon-progress": "AI clothing try-on progress", "bundle-tryon-empty": "Add at least one garment to your cart. Try-on accepts a maximum of 2 garments.", "bundle-tryon-loaded": "Photo uploaded. Your garments are ready.", "bundle-tryon-preparing": "Preparing the selected garments", "bundle-tryon-inputs-ready": "Customer photo and selected garments are ready", "bundle-tryon-ready": "Clothing try-on ready"
  },
  fr: {
    "bundle-tryon-kicker": "Essayage vetements IA", "bundle-tryon-title": "Essayez jusqu'a 2 vetements", "bundle-tryon-description": "L'essayage du paiement modifie uniquement les vetements. Chaussures, sacs et accessoires restent inchanges.", "bundle-tryon-limit": "Vetements uniquement · maximum 2 produits", "bundle-tryon-upload": "Importer votre photo", "bundle-tryon-result-empty": "Votre essayage de vetements apparaitra ici.", "bundle-tryon-generate": "Generer l'essayage", "bundle-tryon-progress": "Progression de l'essayage IA", "bundle-tryon-empty": "Ajoutez au moins un vetement au panier. L'essayage accepte au maximum 2 vetements.", "bundle-tryon-loaded": "Photo importee. Vos vetements sont prets.", "bundle-tryon-preparing": "Preparation des vetements selectionnes", "bundle-tryon-inputs-ready": "Photo client et vetements selectionnes prets", "bundle-tryon-ready": "Essayage des vetements pret"
  },
  de: {
    "bundle-tryon-kicker": "KI-Kleidungsanprobe", "bundle-tryon-title": "Bis zu 2 Kleidungsstucke anprobieren", "bundle-tryon-description": "Die Checkout-Anprobe andert nur Kleidung. Schuhe, Taschen und Accessoires bleiben unverandert.", "bundle-tryon-limit": "Nur Kleidung · maximal 2 Produkte", "bundle-tryon-upload": "Foto hochladen", "bundle-tryon-result-empty": "Ihre Kleidungsanprobe erscheint hier.", "bundle-tryon-generate": "Kleidungsanprobe erstellen", "bundle-tryon-progress": "Fortschritt der KI-Kleidungsanprobe", "bundle-tryon-empty": "Legen Sie mindestens ein Kleidungsstuck in den Warenkorb. Maximal 2 Kleidungsstucke sind erlaubt.", "bundle-tryon-loaded": "Foto hochgeladen. Ihre Kleidung ist bereit.", "bundle-tryon-preparing": "Ausgewahlte Kleidung wird vorbereitet", "bundle-tryon-inputs-ready": "Kundenfoto und ausgewahlte Kleidung sind bereit", "bundle-tryon-ready": "Kleidungsanprobe bereit"
  },
  es: {
    "bundle-tryon-kicker": "Prueba de ropa con IA", "bundle-tryon-title": "Prueba hasta 2 prendas", "bundle-tryon-description": "La prueba del checkout cambia solo la ropa. Zapatos, bolsos y accesorios permanecen sin cambios.", "bundle-tryon-limit": "Solo ropa · maximo 2 productos", "bundle-tryon-upload": "Sube tu foto", "bundle-tryon-result-empty": "Tu prueba de ropa aparecera aqui.", "bundle-tryon-generate": "Generar prueba de ropa", "bundle-tryon-progress": "Progreso de la prueba de ropa con IA", "bundle-tryon-empty": "Anade al menos una prenda al carrito. La prueba acepta un maximo de 2 prendas.", "bundle-tryon-loaded": "Foto subida. Tus prendas estan listas.", "bundle-tryon-preparing": "Preparando las prendas seleccionadas", "bundle-tryon-inputs-ready": "Foto del cliente y prendas seleccionadas listas", "bundle-tryon-ready": "Prueba de ropa lista"
  }
};
...
translations.sq = {
  ...
  "bundle-tryon-kicker": "Prove veshjesh me AI", "bundle-tryon-title": "Provo deri ne 2 veshje", "bundle-tryon-description": "Prova ne checkout ndryshon vetem veshjet. Kepucet, cantat dhe aksesoret mbeten te pandryshuar.", "bundle-tryon-limit": "Vetem veshje · maksimumi 2 produkte", "bundle-tryon-upload": "Ngarko foton tuaj", "bundle-tryon-result-empty": "Prova e veshjeve do te shfaqet ketu.", "bundle-tryon-generate": "Gjenero proven e veshjeve", "bundle-tryon-progress": "Ecuria e proves se veshjeve me AI", "bundle-tryon-empty": "Shtoni te pakten nje veshje ne shporte. Prova pranon maksimumi 2 veshje.", "bundle-tryon-loaded": "Fotoja u ngarkua. Veshjet jane gati.", "bundle-tryon-preparing": "Po pergatiten veshjet e zgjedhura", "bundle-tryon-inputs-ready": "Fotoja e klientit dhe veshjet e zgjedhura jane gati", "bundle-tryon-ready": "Prova e veshjeve eshte gati",
...
translations.ro = {
  ...
  "bundle-tryon-kicker": "Proba hainelor cu AI", "bundle-tryon-title": "Probeaza pana la 2 haine", "bundle-tryon-description": "Proba din checkout schimba doar hainele. Pantofii, gentile si accesoriile raman neschimbate.", "bundle-tryon-limit": "Doar haine · maximum 2 produse", "bundle-tryon-upload": "Incarca fotografia ta", "bundle-tryon-result-empty": "Proba hainelor va aparea aici.", "bundle-tryon-generate": "Genereaza proba hainelor", "bundle-tryon-progress": "Progresul probei hainelor cu AI", "bundle-tryon-empty": "Adauga cel putin o haina in cos. Proba accepta maximum 2 haine.", "bundle-tryon-loaded": "Fotografia a fost incarcata. Hainele sunt gata.", "bundle-tryon-preparing": "Se pregatesc hainele selectate", "bundle-tryon-inputs-ready": "Fotografia clientului si hainele selectate sunt gata", "bundle-tryon-ready": "Proba hainelor este gata",
...
function getBundleTryOnItems() {
  ...
  return sourceItems
    ...
    .filter((item) => item.sizeType === "clothing")
    .filter((item) => {
